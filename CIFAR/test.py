...
if 'cifar10_' in args.method_name:
    test_data = dset.CIFAR10('/home/codebind/energy_ood/data', train=False, transform=test_transform)
    num_classes = 10
else:
    test_data = dset.CIFAR100('/home/codebind/energy_ood/data', train=False, transform=test_transform)
    num_classes = 100
...
if args.score == 'Odin':
    ...
    if 'cifar10_' in args.method_name:
        train_data = dset.CIFAR10('/home/codebind/energy_ood/data', train=True, transform=test_transform)
    else:
        train_data = dset.CIFAR100('/home/codebind/energy_ood/data', train=True, transform=test_transform)
...
# /////////////// Textures ///////////////
ood_data = dset.ImageFolder(root="/home/codebind/energy_ood/data/dtd-r1.0.1/dtd/images",
...
#ood_data = svhn.SVHN(root='/home/codebind/energy_ood/data/svhn', split="test",
...
# /////////////// Places365 ///////////////
ood_data = dset.ImageFolder(root="/home/codebind/energy_ood/data/places365/",
                            transform=trn.Compose([trn.Resize(32), trn.CenterCrop(32),
                                                   trn.ToTensor(), trn.Normalize(mean, std)]))
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,
                                         num_workers=2, pin_memory=True)
...
# /////////////// LSUN-C ///////////////
ood_data = dset.ImageFolder(root="/home/codebind/energy_ood/data/LSUN",
...
# /////////////// LSUN-R ///////////////
ood_data = dset.ImageFolder(root="/home/codebind/energy_ood/data/LSUN_resize",
                            transform=trn.Compose([trn.ToTensor(), trn.Normalize(mean, std)]))
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,
                                         num_workers=1, pin_memory=True)
...
# /////////////// iSUN ///////////////
ood_data = dset.ImageFolder(root="/home/codebind/energy_ood/data/iSUN",
                            transform=trn.Compose([trn.ToTensor(), trn.Normalize(mean, std)]))
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,
                                         num_workers=1, pin_memory=True)
print('\n\niSUN Detection')
