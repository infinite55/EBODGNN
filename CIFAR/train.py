...
if args.dataset == 'cifar10':
    train_data_in = dset.CIFAR10('/home/codebind/energy_ood/data', train=True, transform=train_transform)
    test_data = dset.CIFAR10('/home/codebind/energy_ood/data', train=False, transform=test_transform)
    num_classes = 10
else:
    train_data_in = dset.CIFAR100('/home/codebind/energy_ood/data', train=True, transform=train_transform)
